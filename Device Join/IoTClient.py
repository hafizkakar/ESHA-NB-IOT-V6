...
@pyRAPL.measureit(number=1000,output=csv_output)

def IoT():
    # Hash using ESHA256
    ESHA = True

    serverAddressPort_a   = ("192.168.1.71", 1001)
    serverAddressPort_b   = ("192.168.1.71", 2002)
    serverAddressPort_d   = ("192.168.1.71", 3003)
    bufferSize          = 1024
